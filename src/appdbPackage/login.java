...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Aplikasi Sistem Informasi");

        jLabel2.setText("silahkan isi username dan password");
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        // TODO add your handling code here:
        String usernameLog = uname.getText();
        String passwordLog = String.valueOf(pass.getPassword());
        try{
            ...
            p.setString(1, usernameLog);
            p.setString(2, passwordLog);
